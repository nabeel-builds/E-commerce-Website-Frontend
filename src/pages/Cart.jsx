        ...
        <div className='mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0'>
            {
                cartItem.length > 0 ? <div>
                            ...
                            {cartItem.map((item, index) => {
                                return <div key={index} className='bg-gray-100 p-5 rounded-md flex items-center justify-between mt-3 w-full'>
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <div>
                                            <h1 className='md:w-[300px] md:line-clamp-2 line-clamp-3 '>{item.title}</h1>
                        ...
                        <div className='grid md:grid-cols-2 grid-cols-1 md:gap-20'>
                            <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                                ...
                                <div className='flex flex-col w-full gap-5'>
                                    <div className='flex flex-col space-y-1 w-full'>
                                        ...
                                        <input type="text" placeholder='Enter Your State' className='p-2 rounded-md' value={location?.state} />
                                    </div>
                                    <div className='flex flex-col space-y-1 w-full'>
                                        <label htmlFor="">Postal Code</label>
                                        <input type="text" placeholder='Enter Your Postal Code' className='p-2 rounded-md' value={location?.postcode} />
                                    </div>
                                </div>
                                <div className='flex flex-col w-full gap-5 '>
                                    <div className='flex flex-col space-y-1 w-full'>
                                        <label htmlFor="">Country</label>
                                        <input type="text" placeholder='Enter Your Country' className='p-2 rounded-md' value={location?.country} />
                                    </div>
                                    <div className='flex flex-col space-y-1 w-full'>
                                        <label htmlFor="">Phone No</label>
                                        <input type="text" placeholder='Enter Your Number' className='p-2 rounded-md' />
                                    </div>
                                </div>
                            ...
                            <div className='bg-white border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                                ...
                                <div className='flex justify-between items-center'>
                                    <h1 className='flex gap-1 items-center text-gray-700'><span><LuNotebookText /></span>Total Items</h1>
                                    <p>${totalPrice}</p>
                                </div>
                                <div className='flex justify-between items-center'>
                                ...
                                <div className='flex justify-between items-center'>
                                    <h1 className='flex gap-1 items-center text-gray-700'><span><GiShoppingBag /></span>Hanling Charge</h1>
                                ...
                                <div>
                                    ...
                                    <div className='flex gap-3'>
                                        ...
                                        <button className='bg-white text-black border border-gray-200 px-4 cursor-pointer py-1 rounded-md hover:bg-gray-200 transition-all duration-150'>Apply</button>
                                    </div>
                                </div>
                    ...
                    <img src={emptyCart} alt="" className='w-[350px]'/>
