               ...
               SingleProduct ? <div className='px-4 pb-4 md:px-0'>
                ...
                <div className='max-w-6xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10'>
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <p className='text-xl text-red-500 font-bold'>${SingleProduct.price} <span className='line-through text-gray-700'>${OriginalPrice}</span><span className='bg-red-500 text-white px-4 py-2 ml-2 rounded-full'>{SingleProduct.discountPercentage
} %discount</span></p>
                        ...
                        <div className='flex gap-4 mt-4'>
                            <button onClick={()=>addToCart(SingleProduct)} className='px-6 flex gap-2 py-2 text-lg bg-red-500 text-white rounded-md cursor-pointer hover:scale-105 transition-all'><IoCartOutline className='w-6 h-6'/> Add to Cart</button>
                        </div>
                    </div>
                </div>
               </div> : 
