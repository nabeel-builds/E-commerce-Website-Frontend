...
import { FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaPinterest, FaTwitterSquare } from 'react-icons/fa'
  ...
  return (
    <footer className='bg-gray-900 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            ...
            <div className='flex space-x-4 mt-2'>
                <a href="https://github.com/nabeel-builds" target='_blank'><FaGithub/></a>
                <a href="https://www.linkedin.com/in/nabeel-ahmad-8a818a384/" target='_blank'><FaLinkedin/></a>
                <a href="https://x.com/Nabeeel0786" target='_blank'><BsTwitterX/></a>
                <FaPinterest/>
            </div>
        </div>
      ...
      <div className='flex justify-center items-center mt-5 mb-2'>
        <h2 className='text-lg font-semibold cursor-pointer'>Made by Nabeel ❤</h2>
      </div>
    </footer>
  )
}
